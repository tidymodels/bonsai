...
This outlines how to propose a change to bonsai. For more detailed info
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("tidymodels/bonsai", fork = TRUE)`.
...
of Conduct](https://bonsai.tidymodels.org/dev/CODE_OF_CONDUCT.md). By
