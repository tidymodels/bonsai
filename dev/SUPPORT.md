...
Thanks for using bonsai! Before filing an issue, there are a few places
...
- If it’s a bug: you’re in the right place, [file an
  issue](https://github.com/tidymodels/bonsai/issues/new).
...
requests](https://github.com/tidymodels/bonsai/issues) to make sure the
